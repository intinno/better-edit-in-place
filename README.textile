...
h3. New Features in this Clone

* support for generating controller methods
* support for handling validations
* support for handling the case when the value of the element is null
